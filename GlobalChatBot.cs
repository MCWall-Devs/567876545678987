...
namespace MCForge
{
    public class GlobalChatBot
    {
        ...
        public GlobalChatBot(string nick)
        {
            ...
            server = "irc.mibbit.net"; channel = "#mcchawk"; this.nick = nick.Replace("&9 ", "&9");
        ...
        void Listener_OnPublic(UserInfo user, string channel, string message)
        {
            ...
            Player.GlobalMessage(String.Format("{0}>&e[Global]&9 {1}: &f{2}", Server.GlobalChatColor, user.Nick, Server.profanityFilter ? ProfanityFilter.Parse(message) : message), true);
        }
