...
namespace MCForge.Commands
{
    public class CmdTitle : Command
    {
        ...
        public override void Use(Player p, string message)
        {
            ...
            {
                if (Server.devs.Contains(who.name) || newTitle.ToLower() == "Developer" || (newTitle.ToLower().Contains("Developer") && newTitle.ToLower().Contains("%"))) { Player.SendMessage(p, "Can't let you do that, starfox."); return; }
            }
