    ...
    public class CmdSetRank : Command
    {
        ...
        public override void Use(Player p, string message)
        {
            ...
            else
            {
                ...
                Player.GlobalChat(who, who.color + who.name + Server.DefaultColor + " has been promoted to " + newRank.color + newRank.name, false);
                ...
                who.SendMessage("You are now ranked " + newRank.color + newRank.name + Server.DefaultColor + " &cCongratulations ");
                who.SendUserType(Block.canPlace(who.group.Permission, Block.blackrock));
                Player.GlobalChat(who, who.color + Server.DefaultColor + " Has Been ranked! ");
