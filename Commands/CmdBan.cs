        ...
        public override void Use(Player p, string message)
        {
            try
            {
                ...
                if (who == null)
                {
                    ...
                    {
                        Player.SendMessage(p, "You can't ban a MCWall Developer!");
                        if (p != null)
                        {
                            Player.GlobalMessage(p.color + p.name + Server.DefaultColor + " attempted to ban a MCWall Developer!");
                        }
                        else
                        {
                            Player.GlobalMessage(Server.DefaultColor + "The Console attempted to ban a MCWall Developer!");
                        }
                        return;
                    }
                ...
                else
                {
                    ...
                    {
                        Player.SendMessage(p, "You can't ban an MCWall Developer!");
                        if (p != null)
                        {
                            Player.GlobalMessage(p.color + p.name + Server.DefaultColor + " attempted to ban an MCWall Developer!");
                        }
                        else
                        {
                            Player.GlobalMessage(Server.DefaultColor + "The Console attempted to ban an MCWall Developer!");
                        }
                        return;
                    }
