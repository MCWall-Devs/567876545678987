...
namespace MCForge.Gui
{
    public partial class Window : Form
    {
        ...
        private void Window_Load(object sender, EventArgs e)
        {
            ...
            notifyIcon1.Text = ("MCWall Server: " + Server.name).Truncate(64);
        ...
        void SettingsUpdate()
        {
            ...
            {
                this.Text = Server.name + " - MCWall " + Server.Version;
                notifyIcon1.Text = ("MCWall Server: " + Server.name).Truncate(64);
            }
        }
        ...
        private void Window_FormClosing(object sender, FormClosingEventArgs e)
        {
            ...
            if (Server.shuttingDown == true || MessageBox.Show("If server is shutdown, you will need to re-open it for it to be public", "Exit", MessageBoxButtons.OKCancel) == DialogResult.OK)
            {
